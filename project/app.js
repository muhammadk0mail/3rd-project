...
function getyoutubeplaylistjs() {
  ...
  function func_filter() {
    ...
    var change1 = document.getElementById('step#04');
    ...
    function showplaylist() {
      ...
      if (y.style.display === "none") {
        ...
        change1.innerHTML = "<i class='fab fa-youtube fs-3'></i> 3. Select Your Zoom Account & playlist to connect";
      } else {
        y.style.display = "none";
        change1.innerHTML = "<i class='fab fa-youtube fs-3'></i> 3. Select Your Zoom Account";
      }
    }
